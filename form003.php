...
if (isset($_POST['gender'])){
 ...
 header("location: form002.php"); // Redirecting to second page. 
 } else {
 ...
 header("location: form001.php");// Redirecting to first page.
 }
}
?>
<!DOCTYPE HTML>
<html>
 <head>
 <title>My Friends  & Teachers Detail</title>
 <link rel="stylesheet" href="style.css" />
 </head>
 <body>
 <div class="container">
 <div class="main">
 <h2>My Friends  & Teachers Detail</h2><hr/>
 <span id="error">
 <?php
 if (!empty($_SESSION['error_page3'])) {
 ...
 <form action="form004.php" method="post">
